...
- Implemented **safe-failure engineering**: enrichment and AI provider failures always fail closed to analyst review (never to escalation or false safety), backed by 90+ automated tests enforced fully offline via `pytest-socket`, plus CI-integrated dependency-vulnerability and full-history secret scanning.
